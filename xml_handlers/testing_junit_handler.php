...
/*=========================================================================
  ...
  Module:    $Id: testing_junit_handler.php 3379 2013-10-28 13:15:36Z jjomier $
  Language:  PHP
  Date:      $Date: 2013-10-28 09:15:36 -0400 (Mon, 28 Oct 2013) $
...
class TestingJUnitHandler extends AbstractHandler
{
  ...
  public function startElement($parser, $name, $attributes)
    ...
    else if($name == "PROPERTY" && $parent == "PROPERTIES" )
      {
    ...
    else if($name == "TESTCASE" && count($attributes) > 0)
      {
  ...
  public function endElement($parser, $name)
    ...
    if($name == "FAILURE")
      ...
      else if($this->BuildTest->Status == "failed")
        {
    ...
    else if($name == "SITE" || ($this->HasSiteTag == false && $name == "TESTSUITE"))
      {

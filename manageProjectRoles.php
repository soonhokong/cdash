...
/*=========================================================================
  ...
  Module:    $Id: manageProjectRoles.php 3335 2013-07-17 21:38:13Z zack.galbreath $
  Language:  PHP
  Date:      $Date: 2013-07-17 17:38:13 -0400 (Wed, 17 Jul 2013) $
...
if(isset($_POST["sendEmailToSiteMaintainers"]))
  ...
  if(strlen($emailMaintainers)<50)
    ...
    if($email != "")
      {
      if(  @cdashmail("$email", "CDash - ".$projectname." : To Site Maintainers","$emailMaintainers","From: $CDASH_EMAILADMIN\nReply-To: no-reply\nContent-type: text/plain; charset=utf-8\nX-Mailer: PHP/" . phpversion()."\nMIME-Version: 1.0\nContent-type: text/html; charset=UTF-8"))
        {
